...
import { Coffee, MapPin, Star, Calendar, MessageSquare, ChevronRight, Heart, Utensils, Home, DollarSign } from "lucide-react";
...
export default async function UserProfilePage(props: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="min-h-screen bg-white pb-28">
            ...
            <div className="pt-12 pb-8 px-6 border-b border-zinc-50 bg-zinc-50/30">
            ...
            <div className="px-6 -mt-6 grid grid-cols-2 gap-3 mb-8">
                <div className="bg-white p-3 rounded-2xl border border-zinc-100 shadow-sm flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm font-black text-zinc-900 leading-none">{profile.stats.visits}</p>
                ...
                <div className="bg-white p-3 rounded-2xl border border-zinc-100 shadow-sm flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm font-black text-zinc-900 leading-none">{profile.stats.reviews}</p>
                            ...
                            <div className="space-y-3">
                                {reviews.map((rev: any) => (
                                    <div key={rev.id} className="bg-zinc-50/50 p-4 rounded-lg border border-zinc-100 space-y-3">
                                        <div className="flex items-center justify-between">
                                            <Link href={`/shops/${rev.shopId}`} className="text-xs font-black text-primary hover:underline flex items-center gap-1">
