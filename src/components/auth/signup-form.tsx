    ...
    return (
        <Card className="w-full bg-white/10 backdrop-blur-xl border-white/20 shadow-2xl overflow-hidden rounded-3xl">
            <CardHeader className="text-white">
                <CardTitle className="text-2xl font-bold tracking-tight">Crea una cuenta</CardTitle>
                <CardDescription className="text-white/60 font-medium">
                    Ingresa tus datos para empezar tu pasaporte de café.
                </CardDescription>
            </CardHeader>
            <form onSubmit={handleSubmit}>
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="name" className="text-white/80 font-semibold ml-1">Nombre</Label>
                        <Input
                            id="name"
