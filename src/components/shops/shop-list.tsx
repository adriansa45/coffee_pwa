        ...
        <div className="space-y-6">
            <div className="relative group">
                ...
                <input
                    ...
                    className="w-full bg-muted/50 rounded-xl py-4 pl-12 pr-14 text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/10 border border-border"
                />

                <Drawer>
                    <DrawerTrigger asChild>
                        <button className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-lg bg-primary/10 hover:bg-primary/20 text-primary transition-colors border border-primary/10">
                            <Filter size={18} className={selectedFeatures.length > 0 ? "fill-primary" : ""} />
                            {selectedFeatures.length > 0 && (
                                <span className="absolute -top-1 -right-1 w-4 h-4 bg-primary text-primary-foreground text-[10px] flex items-center justify-center rounded-md font-bold">
                    ...
                    <DrawerContent>
                        <div className="mx-auto w-full max-w-sm">
                                        ...
                                        return (
                                            ...
                                            >
                                                {IconComponent ? (
                                                    ...
                                                    <div className="w-3.5 h-3.5 flex items-center justify-center bg-muted rounded-md text-[8px]">
                            ...
                            <DrawerFooter>
                                <DrawerClose asChild>
                                    <Button className="rounded-xl py-6 font-bold">Ver {displayShops.length} resultados</Button>
                                </DrawerClose>
                            </DrawerFooter>
                        </div>
                    </DrawerContent>
            ...
            <div className="grid grid-cols-1 gap-4">
                ...
                {displayShops.length === 0 && !loading && (
                    <div className="text-center py-20 bg-muted/30 rounded-xl border border-border">
                        <p className="text-muted-foreground font-medium">No se encontraron cafeterías</p>
                    </div>
                )}
            </div>
            ...
            <div ref={observerTarget} className="py-8 flex justify-center">
                ...
                {!hasMore && displayShops.length > 0 && (
                    <div className="text-muted-foreground text-xs font-bold py-4 uppercase tracking-widest">
