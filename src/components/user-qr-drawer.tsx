    ...
    return (
        <Drawer>
            <DrawerTrigger asChild>
                <button className="absolute bottom-40 right-5 z-[500] w-14 h-14 bg-white text-brand-950 rounded-full shadow-xl flex items-center justify-center transition-transform hover:scale-105 active:scale-95 border-2 border-brand-100">
                    <QrCode size={24} />
                </button>
            </DrawerTrigger>
            <DrawerContent>
                <div className="mx-auto w-full max-w-sm">
                    <DrawerHeader className="text-center">
                        <DrawerTitle className="text-2xl font-bold text-brand-950">Tu Pasaporte Café</DrawerTitle>
                        <DrawerDescription>
                        ...
                        {isPending ? (
                            ...
                            <div className="bg-white p-4 rounded-2xl border-2 border-brand-100 shadow-sm">
                                <QRCode
                                    ...
                                    viewBox={`0 0 256 256`}
                                />
                                <p className="text-center mt-4 font-mono text-lg font-bold text-brand-900 tracking-widest">
                                    {userCode}
                                </p>
                            </div>
                        ) : (
